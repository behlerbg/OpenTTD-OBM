...
class OBMApp(tk.Tk):
    ...
    def create_widgets(self):
        ...
        tk.Label(self, text='OBM Metadata', font=LARGE_FONT, bg=GREY).grid(row=0, column=0, columnspan=5, sticky='NW', padx=5, pady=10)

        self.meta_name_val = tk.StringVar()
        tk.Label(self, text='Name:', font=MEDIUM_FONT, bg=GREY).grid(row=1, column=0, sticky='NW', padx=5, pady=1)
        self.meta_name = tk.Entry(self, textvariable=self.meta_name_val, bg=BLACK, fg=BLUE, font=MEDIUM_FONT)
        ...
        tk.Label(self, text='Shortname:', font=MEDIUM_FONT, bg=GREY).grid(row=2, column=0, sticky='NW', padx=5, pady=1)
        self.meta_shortname = tk.Entry(self, textvariable=self.shortname_val, bg=BLACK, fg=BLUE, font=MEDIUM_FONT)
        ...
        tk.Label(self, text='Version:', font=MEDIUM_FONT, bg=GREY).grid(row=3, column=0, sticky='NW', padx=5, pady=1)
        self.meta_version = tk.Entry(self, textvariable=self.version_val, bg=BLACK, fg=BLUE, font=MEDIUM_FONT)
        ...
        tk.Label(self, text='Description:', font=MEDIUM_FONT, bg=GREY).grid(row=4, column=0, sticky='NW', padx=5, pady=1)
        self.meta_description = tk.Entry(self, textvariable=self.description_val, bg=BLACK, fg=BLUE, font=MEDIUM_FONT)
        ...
        tk.Label(self, text='Origin:', font=MEDIUM_FONT, bg=GREY).grid(row=5, column=0, sticky='NW', padx=5, pady=1)
        self.meta_origin = tk.Entry(self, textvariable=self.origin_val, bg=BLACK, fg=BLUE, font=MEDIUM_FONT)
        self.meta_origin.grid(row=5, column=1, columnspan=4, sticky='NEW', padx=5)
        self.meta_origin.insert(0, 'https://')


        ## Midifile Configuration
        tk.Label(self, text='Track Information: ', font=LARGE_FONT, bg=GREY).grid(row=6, column=0, sticky='NW', padx=5, pady=10)
        ...
        tk.Label(self, text='Name:', font=MEDIUM_FONT, bg=GREY).grid(row=7, column=0, padx=5, pady=1, sticky='NW')
        self.track_name = tk.Entry(self, textvariable=self.track_name_val, bg=BLACK, fg=BLUE, font=MEDIUM_FONT)
        self.track_name.grid(row=7, column=1, columnspan=4, sticky='NEW', padx=5)
        self.track_name.insert(0, 'Name of current track')

        ## Style Configuration
        tk.Label(self, text='TRACK INDEX', font=LARGE_FONT, bg=GREY).grid(row=8, column=0, sticky='NSE', padx=5, pady=10)
        import_btn = tk.Button(self, text='IMPORT...', command=self.import_tracks, width=15, font=SMALL_FONT, bg=GREY, fg=BLACK)
        import_btn.grid(row=8, column=1, sticky='NE', pady=10, padx=5)

        tk.Label(self, text='PROGRAM -', font=LARGE_FONT, bg=GREY).grid(row=8, column=3, sticky='NSE', padx=5, pady=10)
        self.style_label = tk.Label(self, font=LARGE_FONT, bg=GREY)
        self.style_label.grid(row=8, column=4, sticky='NSW', padx=5, pady=10)

        self.track_listbox = tk.Listbox(self, bg=BLACK, fg=BLUE, width=40, font=SMALL_FONT)
        self.track_listbox.grid(row=9, column=0, columnspan=2, rowspan=8, sticky='NSEW', padx=5)

        self.style_listbox = tk.Listbox(self, bg=BLACK, fg=BLUE, width=40, font=SMALL_FONT)
        self.style_listbox.grid(row=9, column=3, columnspan=2, rowspan=8, sticky='NSEW', padx=5)

        self.theme_btn = tk.Button(self, text='THEME', command=lambda: self.switch_style('theme'), width=15, font=SMALL_FONT, bg=GREY, fg=BLACK)
        self.theme_btn.grid(row=9, column=2, sticky='NSEW', padx=10, pady=10)

        self.old_btn = tk.Button(self, text='OLD STYLE', command=lambda: self.switch_style('old'), width=15, font=SMALL_FONT, bg=GREY, fg=BLACK)
        self.old_btn.grid(row=10, column=2, sticky='NSEW', padx=10, pady=10)

        self.new_btn = tk.Button(self, text='NEW STYLE', command=lambda: self.switch_style('new'), width=15, font=SMALL_FONT, bg=GREY, fg=BLACK)
        self.new_btn.grid(row=11, column=2, sticky='NSEW', padx=10, pady=10)

        self.ezy_btn = tk.Button(self, text='EZY STREET', command=lambda: self.switch_style('ezy'), width=15, font=SMALL_FONT, bg=GREY, fg=BLACK)
        self.ezy_btn.grid(row=12, column=2, sticky='NSEW', padx=10, pady=10)

        tk.Label(self, text='', bg=GREY).grid(row=13, column=2, sticky='NSEW')

        self.add_btn = tk.Button(self, text='ADD >>', command=add_track, width=15, font=SMALL_FONT, bg=GREY, fg=BLACK)
        self.add_btn.grid(row=14, column=2, sticky='NSEW', padx=10, pady=10)

        self.ezy_btn = tk.Button(self, text='<< REMOVE', command=remove_track, width=15, font=SMALL_FONT, bg=GREY, fg=BLACK)
        self.ezy_btn.grid(row=15, column=2, sticky='NSEW', padx=10, pady=10)

        self.ezy_btn = tk.Button(self, text='CLEAR', command=clear_style, width=15, font=SMALL_FONT, bg=GREY, fg=BLACK)
